...
export const ORANGE_HOVER = '#ffa403';
...
export const LIGHT_GRAYISH_BLUE = '#F0F4F9';
export const LIGHT_GRAYISH_GREEN = '#d0e9c6';
...
export const PRIMARY_COLOR = '#ae0955';
...
export const hexToRgb = (input) => {
  ...
  newInput = input.toUpperCase(newInput);
